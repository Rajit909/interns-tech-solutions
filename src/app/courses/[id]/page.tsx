...
import { Star, Clock, Users, Bookmark, MessageSquare, CheckCircle, ArrowRight } from 'lucide-react';
...
export default function CoursePreviewPage({ params }: { params: { id: string } }) {
  ...
  const handleEnrollClick = () => {
    // Redirect to the dashboard course page, which will trigger auth middleware if not logged in.
            ...
            <div className="space-y-6">
              <Card className="sticky top-24">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button size="lg" variant="outline" className="w-full" onClick={handleEnrollClick}>
