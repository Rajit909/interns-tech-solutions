...
export default function StudentDashboardPage() {
    ...
    return (
        <div className="space-y-8">
            ...
            <section>
                <h2 className="text-2xl font-semibold tracking-tight mb-4">My Enrolled Courses</h2>
                {coursesLoading && (
                ...
                {coursesError && <p className="text-destructive">Failed to load your enrolled courses.</p>}
