...
export default function TakeQuizPage() {
  ...
  const { data, error, isLoading } = useSWR(quizId ? `/api/quizzes/${quizId}`: null, fetcher);
  ...
  if (error || !data || !data.quiz) return notFound();
  ...
  if (isFinished) {
    return <QuizResults quiz={quiz} score={score} selectedAnswers={selectedAnswers} onFinish={() => router.push('/dashboard/quizzes')} />;
  }
